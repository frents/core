...
export type AuthMutationResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['AuthMutationResponse'] = ResolversParentTypes['AuthMutationResponse']> = {
...
*/
export type IDirectiveResolvers<ContextType = any> = DirectiveResolvers<ContextType>;import gql from 'graphql-tag';
